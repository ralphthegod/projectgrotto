...
public class GrottoRenderSystem extends RenderSystem{
    ...
    public boolean draw(Entity entity, float deltaTime) {
        ...
        // Only last camera component is considered
    ...
    public void draw(RenderComponent render, float x, float y, float angle, float velocityX, float velocityY, float deltaTime) {
        ...
        // Flip the bitmap if the entity is moving to the left
        if (velocityX < 0) {
